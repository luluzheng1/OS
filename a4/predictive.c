 ...
 */
int pg_alloc[MAXPROCESSES];
int proc_faults[MAXPROCESSES];
int proc_susp[MAXPROCESSES];
int proc_last_evict[MAXPROCESSES];
int proc_last_unsat[MAXPROCESSES];
int proc_last_pagein[MAXPROCESSES];
struct phist_record
{
    int page;
    int fault;
...
static void pred_pageit(Pentry q[MAXPROCESSES], uint32_t tick, struct phist *phist_arr)
{
...
void pageit(Pentry q[MAXPROCESSES])
{
    ...
    struct phist *phist_arr = malloc(MAXPROCESSES * sizeof(struct phist));
